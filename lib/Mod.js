var fs = require('fs'),
    ...
    ASTNodeCtors = require('./ast-utils/nodeCtors'),
    Program  = ASTNodeCtors.Program,
    Identifier = ASTNodeCtors.Identifier,
    VariableDeclaration = ASTNodeCtors.VariableDeclaration,
    BlockStatement = ASTNodeCtors.BlockStatement,

    astDecorator = require('./ast-utils/astDecorator'),
...
Mod.prototype.sortDependencies = function () {
    var sorted = [];
    // given how long it took me to realize this, I feel rather dumb.
