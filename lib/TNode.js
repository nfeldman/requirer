 ...
 * via `append`, `prepend`, `before`, or `after` will enforce tree structure, 
 * and it is recommended that these methods be used in place of direct 
 * manipulation of a node's `children` array.
 * 
 ...
 * TNode has static methods for the following traversal functions, 
 * the callbacks are applied to the above tree in the order shown below:
 * 
 ...
 * 
 * @example
 *  given the the tree built at the top of this file and a callback that
 *  prints the value of each node, the output should be:
 *  1 2 4 7 5 3 6 8 9
 */
